...
namespace HallApp.Infrastructure.Migrations
{
    ...
    [Migration("20260823205918_SupportHallApplications")]
    partial class SupportHallApplications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChamperEntities.Hall", b =>
                {
                    ...
                    b.Property<int?>("AssignedToHallManagerId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AssignedToHallManagerId");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChamperEntities.HallBlockedDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChatEntities.ChatMessageReadStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChatEntities.ChatRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChatEntities.SupportCase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.OrganizationMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("CanCreateResources")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ReviewEntities.Review", b =>
                {
                    ...
                    b.Property<int?>("ManagerResponderId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ManagerResponderId");

                    b.HasIndex("VendorId");

                    b.HasIndex("HallId", "IsFlagged");

                    b.HasIndex("HallId", "Rating");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.VendorEntities.Vendor", b =>
                {
                    ...
                    b.Property<int?>("AssignedToVendorManagerId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AssignedToVendorManagerId");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.VendorEntities.VendorApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("CreatedHallId")
                        .HasColumnType("integer");

                    b.Property<int?>("CreatedOrganizationId")
                        .HasColumnType("integer");

                    b.Property<int?>("CreatedVendorId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.VendorEntities.VendorDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("VendorApplicationId", "DocumentType")
                        .IsUnique();
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChamperEntities.Hall", b =>
                {
                    b.HasOne("HallApp.Core.Entities.ChamperEntities.HallManager", "AssignedToHallManager")
                        .WithMany()
                        .HasForeignKey("AssignedToHallManagerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("HallApp.Core.Entities.Organization", "Organization")
                        .WithMany("Halls")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("AssignedToHallManager");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChamperEntities.HallBlockedDate", b =>
                {
                    b.HasOne("HallApp.Core.Entities.AppUser", "BlockedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChatEntities.ChatConversation", b =>
                {
                    ...
                    b.HasOne("HallApp.Core.Entities.AppUser", "ClosedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChatEntities.ChatMessageReadStatus", b =>
                {
                    b.HasOne("HallApp.Core.Entities.ChatEntities.ChatMessage", "Message")
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ChatEntities.SupportCase", b =>
                {
                    ...
                    b.HasOne("HallApp.Core.Entities.ChatEntities.ChatConversation", "Conversation")
                        .WithOne("Case")
                        .HasForeignKey("HallApp.Core.Entities.ChatEntities.SupportCase", "ConversationId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("HallApp.Core.Entities.Organization", b =>
                {
                    b.HasOne("HallApp.Core.Entities.AppUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("HallApp.Core.Entities.OrganizationMember", b =>
                {
                    ...
                    b.HasOne("HallApp.Core.Entities.AppUser", "InvitedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HallApp.Core.Entities.ReviewEntities.Review", b =>
                {
                    ...
                    b.HasOne("HallApp.Core.Entities.AppUser", "FlaggedByUser")
                        .WithMany()
                    ...
                    b.HasOne("HallApp.Core.Entities.AppUser", "ManagerResponder")
                        .WithMany()
                        .HasForeignKey("ManagerResponderId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("HallApp.Core.Entities.VendorEntities.Vendor", b =>
                {
                    b.HasOne("HallApp.Core.Entities.VendorEntities.VendorManager", "AssignedToVendorManager")
                        .WithMany()
                        .HasForeignKey("AssignedToVendorManagerId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("AssignedToVendorManager");
            ...
            modelBuilder.Entity("HallApp.Core.Entities.VendorEntities.VendorDocument", b =>
                {
                    b.HasOne("HallApp.Core.Entities.VendorEntities.VendorApplication", "VendorApplication")
                        .WithMany("Documents")
