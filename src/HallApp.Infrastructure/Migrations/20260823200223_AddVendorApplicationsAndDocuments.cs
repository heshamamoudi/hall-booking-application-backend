...
{
    /// <inheritdoc />
    public partial class AddVendorApplicationsAndDocuments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<string>(
                name: "SupplierCommercialRegistrationNumber",
                table: "PurchaseOrders",
                type: "character varying(50)",
                maxLength: 50,
                nullable: false,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommercialRegistrationNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    CreatedVendorId = table.Column<int>(type: "integer", nullable: true),
                    CreatedOrganizationId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorApplications_Users_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VendorApplications_VendorTypes_VendorTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    VendorApplicationId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ReviewComment = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ReviewedByUserId = table.Column<int>(type: "integer", nullable: true),
                    ReviewedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorDocuments_VendorApplications_VendorApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorApplications_AppUserId",
                table: "VendorApplications",
                column: "AppUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VendorApplications_ContactEmail",
                table: "VendorApplications",
                column: "ContactEmail");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorApplications_VendorTypeId",
                table: "VendorApplications",
                column: "VendorTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorDocuments_Status",
                table: "VendorDocuments",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_VendorDocuments_VendorApplicationId_DocumentType",
                table: "VendorDocuments",
                columns: new[] { "VendorApplicationId", "DocumentType" },
                unique: true);
        }
